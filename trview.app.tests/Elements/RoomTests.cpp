    ...
    auto register_test_module()
    {
        struct test_module
        {
            ...
            std::shared_ptr<Room> build()
            {
                ...
                new_room->initialise(*tr_level, room, *mesh_storage, static_mesh_source, static_mesh_position_source, sector_source, 0, Activity(log, "Level", "Room 0"), sampler_source);
                return new_room;
            }
