...
TEST(Room, GetTransparentTriangles)
{
    ...
    MockTransparencyBuffer transparency;
    room->get_transparent_triangles(transparency, MockCamera{}, IRoom::SelectionMode::NotSelected, true, true);
}
...
TEST(Room, GetTransparentTrianglesWithoutTriggers)
{
    ...
    room->add_trigger(trigger);
    MockTransparencyBuffer transparency;
    room->get_transparent_triangles(transparency, MockCamera{}, IRoom::SelectionMode::NotSelected, false, true);
}
...
TEST(Room, GetTransparentTrianglesFromContents)
{
    ...
    room->add_trigger(trigger);
    MockTransparencyBuffer transparency;
    room->get_contained_transparent_triangles(transparency, MockCamera{}, IRoom::SelectionMode::NotSelected, true);
}
