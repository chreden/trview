...
TEST(CameraPosition, RotationsCorrectlyConverted)
{
    ...
    ASSERT_FLOAT_EQ(std::get<0>(value.value()), 1.5707963267948966192313216916398f);
...
{
    CameraPosition subject;
    subject.set_rotation(-1.5707963267948966192313216916398f, 1.0f);
    ...
    ASSERT_TRUE(value);
    ASSERT_FLOAT_EQ(std::get<0>(value.value()), 4.7123889803846898576939650749193f);
