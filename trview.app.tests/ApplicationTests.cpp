...
#include <trview.app/Mocks/Windows/IFloordataWindowManager.h>
...
namespace
{
    ...
    auto register_test_module()
    {
        struct test_module
        {
            ...
            std::unique_ptr<IFloordataWindowManager> floordata_window_manager{ mock_unique<MockFloordataWindowManager>() };
            ...
            std::unique_ptr<Application> build()
            {
                ...
                return std::make_unique<Application>(window, std::move(update_checker), std::move(settings_loader),
                    ...
                    std::move(textures_window_manager), std::move(floordata_window_manager));
            }
