...
namespace trview
{
    ...
    LevelInfo::LevelInfo(ui::Control& control, const ITextureStorage& texture_storage)
    {
        ...
        auto name = std::make_unique<Label>(Point(), Size(74, 16), Colour(1.0f, 0.5f, 0.5f, 0.5f), L"No level", 10.0f, graphics::TextAlignment::Centre, graphics::ParagraphAlignment::Centre, SizeMode::Auto);
