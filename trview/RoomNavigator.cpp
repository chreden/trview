...
namespace trview
{
    RoomNavigator::RoomNavigator(ui::Control& parent, const ITextureStorage& texture_storage)
    {
        ...
        auto room_number_label = std::make_unique<Label>(Point(),Size(8, 16), Colour(1.0f, 0.5f, 0.5f, 0.5f), L" / ", 8.0f, graphics::TextAlignment::Left, graphics::ParagraphAlignment::Centre, SizeMode::Auto);
        auto room_max_label = std::make_unique<Label>(Point(), Size(40, 20), Colour(1.0f, 0.4f, 0.4f, 0.4f), L"0", 8.0f, graphics::TextAlignment::Centre, graphics::ParagraphAlignment::Centre);
        ...
        auto x_label = std::make_unique<Label>(Point(), Size(40, 16), Colour(1.0f, 0.5f, 0.5f, 0.5f), L"X:", 8.0f, graphics::TextAlignment::Left, graphics::ParagraphAlignment::Centre);
        auto z_label = std::make_unique<Label>(Point(), Size(40, 16), Colour(1.0f, 0.5f, 0.5f, 0.5f), L"Z:", 8.0f, graphics::TextAlignment::Left, graphics::ParagraphAlignment::Centre);
