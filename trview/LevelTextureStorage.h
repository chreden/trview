...
namespace trview
{
    ...
    public:
        ...
        virtual DirectX::SimpleMath::Vector4 palette_from_texture(uint32_t texture) const override;
        virtual DirectX::SimpleMath::Vector4 palette(uint32_t index) const override;
    private:
