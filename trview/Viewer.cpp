...
namespace trview
{
    ...
    void Viewer::generate_ui()
    {
        ...
        auto picking = std::make_unique<ui::Label>(Point(500, 0), Size(30, 30), Colour(1, 0.5f, 0.5f, 0.5f), L"0", 8.0f, graphics::TextAlignment::Centre, graphics::ParagraphAlignment::Centre);
