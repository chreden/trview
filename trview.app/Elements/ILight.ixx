...
export module trview.app:ILight;
...
namespace trview
{
    ...
    export bool has_colour(const ILight& light);
    export bool has_direction(const ILight& light);
    export bool has_fade(const ILight& light);
    export bool has_intensity(const ILight& light);
    export bool has_position(const ILight& light);
    export bool has_hotspot(const ILight& light);
    export bool has_falloff(const ILight& light);
    export bool has_falloff_angle(const ILight& light);
    export bool has_length(const ILight& light);
    export bool has_cutoff(const ILight& light);
    export bool has_rad_in(const ILight& light);
    export bool has_rad_out(const ILight& light);
    export bool has_range(const ILight& light);
    export bool has_density(const ILight& light);
    export bool has_radius(const ILight& light);
    export float fade(const ILight& light);
    export float intensity(const ILight& light);
    export float hotspot(const ILight& light);
    export float falloff(const ILight& light);
    export float falloff_angle(const ILight& light);
    export float length(const ILight& light);
    export float cutoff(const ILight& light);
    export float rad_in(const ILight& light);
    export float rad_out(const ILight& light);
