...
namespace trview
{
    namespace messages
    {
        ...
        namespace commands
        {
            ...
            {
                return read_message<bool>(message, "update_available");
            }

            void send_update_available(const std::weak_ptr<IMessageSystem>& messaging)
            {
                send_message(messaging, true, "update_available");
            }
        ...
        {
            return read_message<std::vector<std::string>>(message, "local_levels");
        }

        void send_local_levels(const std::weak_ptr<IMessageSystem>& messaging, const std::vector<std::string>& levels)
        {
            send_message(messaging, levels, "local_levels");
        }
