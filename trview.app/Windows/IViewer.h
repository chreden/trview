...
namespace trview
{
    struct IViewer
    {
        struct Options
        {
            ...
            inline static const std::string portals_enabled = "Portals";
            inline static const std::string horizontal_portals = "Horizontal Portals";
            inline static const std::string vertical_portals = "Vertical Portals";
        };
