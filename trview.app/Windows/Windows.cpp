...
namespace trview
{
    ...
    Windows::Windows(
        ...
        std::unique_ptr<IModelsWindowManager> meshes_window_manager,
        ...
        _log_windows(std::move(log_window_manager)), _meshes_windows(std::move(meshes_window_manager)), _plugins_windows(std::move(plugins_window_manager)),
    ...
    void Windows::update(float elapsed)
    {
        ...
        _meshes_windows->update(elapsed);
    ...
    void Windows::set_level(const std::weak_ptr<ILevel>& level)
    {
        ...
        _meshes_windows->set_model_storage(new_level->model_storage());
