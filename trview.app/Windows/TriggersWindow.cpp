...
namespace trview
{
    ...
    TriggersWindow::TriggersWindow(const std::shared_ptr<IDevice>& device, const std::shared_ptr<IShaderStorage>& shader_storage, const std::shared_ptr<IFontFactory>& font_factory, const Window& parent)
