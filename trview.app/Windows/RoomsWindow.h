...
namespace trview
{
    ...
    public:
        ...
        explicit RoomsWindow(const std::shared_ptr<graphics::IDevice>& device, const ui::render::IRenderer::RendererSource& renderer_source, const ui::render::IMapRenderer::MapRendererSource& map_renderer_source, const Window& parent);
