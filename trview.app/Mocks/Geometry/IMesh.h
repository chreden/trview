...
namespace trview
{
    namespace mocks
    {
        struct MockMesh : public IMesh
        {
            MockMesh();
            virtual ~MockMesh();
            MOCK_METHOD(void, render, (const DirectX::SimpleMath::Matrix&, const ILevelTextureStorage&, const DirectX::SimpleMath::Color&, float, DirectX::SimpleMath::Vector3, bool, bool, bool), (override));
