...
namespace trview
{
    namespace mocks
    {
        ...
        public:
            ...
            MOCK_METHOD(void, render, (const Microsoft::WRL::ComPtr<ID3D11DeviceContext>&, const DirectX::SimpleMath::Matrix&, const ILevelTextureStorage&, const DirectX::SimpleMath::Color&, DirectX::SimpleMath::Vector3));
