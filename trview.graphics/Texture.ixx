...
export module trview.graphics:Texture;
...
namespace trview
{
    namespace graphics
    {
        ...
        export Texture create_texture(const IDevice& device, uint32_t width, uint32_t height, const Colour& colour);

        /// Create a 1x1 texture filled with the specified colour.
        /// @param device The device to use.
        /// @param colour The colour to fill the texture.
        export Texture create_texture(const IDevice& device, const Colour& colour);
        ...
        export Texture load_texture_from_resource(const IDevice& device, const std::wstring& resource_name);
    }
}
