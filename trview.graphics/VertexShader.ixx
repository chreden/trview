...
namespace trview
{
    namespace graphics
    {
        export class VertexShader final : public IShader
        {
        public:
            ...
            VertexShader(const graphics::IDevice& device, const std::vector<uint8_t>& data, const std::vector<D3D11_INPUT_ELEMENT_DESC>& input_desc);
