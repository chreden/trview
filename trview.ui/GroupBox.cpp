...
namespace trview
{
    namespace ui
    {
            ...
            : Window(point, size, background_colour), _border_colour(border_colour), _text(text)
        {
            ...
            auto label = std::make_unique<Label>(Point(10, 0), Size(55, 20), background_colour, text, 10.f, graphics::TextAlignment::Left, graphics::ParagraphAlignment::Near, SizeMode::Auto);
