...
namespace trview
{
    namespace ui
    {
        ...
        const std::string NumericUpDown::Names::value = "numeric_up_down_value";
        ...
        void NumericUpDown::set_value(int32_t value)
        {
            ...
            _value = new_value;
            _label->set_text(std::to_wstring(_value));
            on_invalidate();
        }
        ...
        void NumericUpDown::set_minimum(int32_t minimum)
        {
            _minimum = minimum;
            set_value(_value);
        }
