...
namespace trview
{
    namespace ui
    {
        ...
        {
            add_child(std::make_unique<Label>(Point(2,2), size - Size(4,4), Colour(1.0f, 0.4f, 0.4f, 0.4f), text, 8.0f, graphics::TextAlignment::Centre, graphics::ParagraphAlignment::Centre));
        }
