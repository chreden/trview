...
namespace trview
{
    namespace ui
    {
        ...
        namespace render
        {
            MapRenderer::MapRenderer(const graphics::IDevice& device, const std::shared_ptr<graphics::IShaderStorage>& shader_storage, const graphics::IFontFactory& font_factory, const Size& window_size)
                : _device(device),
