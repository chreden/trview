export module trview.common:Resources;
...
namespace trview
{
    ...
    export Resource get_resource_memory(int resource_id, const wchar_t* resource_type);
    /// <summary>
    /// Get the data for the specified resource.
    /// </summary>
    ...
    /// <returns>The resource.</returns>
    export Resource get_resource_memory(const std::wstring& resource_name, const wchar_t* resource_type);
    /// <summary>
    /// Get all resources of the specified type.
    /// </summary>
    /// <param name="type">The type to search for.</param>
    /// <returns>The resource names.</returns>
    export std::vector<std::wstring> get_resource_names_of_type(const std::wstring& type);
}
